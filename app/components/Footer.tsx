  ...
  const footerLinks = {
    sections: [
      ...
      },
      {
        title: 'Projects',
        links: [
          { name: 'SecondCycle', href: '#projects' },
          { name: 'Resonance Residence', href: '#projects' },
          { name: 'LittleFairyFlorist', href: '#projects' },
          { name: 'StudySyncs', href: '#projects' },
        ]
      },
      {
        title: 'Connect',
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex space-x-4">
              ...
              <a 
                href="https://linkedin.com/gustavito-putra" 
                target="_blank" 
                rel="noopener noreferrer"
                className="w-10 h-10 bg-slate-800 rounded-full flex items-center justify-center text-gray-400 hover:text-white hover:bg-purple-500/20 hover:scale-110 transition-all duration-200"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex flex-col sm:flex-row items-center gap-4 text-sm text-gray-400">
              <span>© {currentYear} Gustavito. All rights reserved.</span>
            ...
            <div className="flex items-center gap-4">
              <span className="text-sm text-gray-400">Made with Next.js & Tailwind CSS</span>
              <button
                onClick={scrollToTop}
                className="w-10 h-10 bg-slate-800 hover:bg-purple-500/20 rounded-full flex items-center justify-center text-gray-400 hover:text-white transition-all duration-200 group"
